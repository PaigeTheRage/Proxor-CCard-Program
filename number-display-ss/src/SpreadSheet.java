...
//form.format("%.8G",Double.parseDouble(val));
...
String x =String.format("%.7g",Double.parseDouble(val));
                        
if(x.contains("e")){
                        
System.out.println("here");
                        
cellsTF[r][c].setText(String.format("%.3g", Double.parseDouble(x)));
...
return;
        ...
        String x =String.format("%.4g", Double.parseDouble(formula));
        cellsTF[r][c].setText(x);
        ...
        {
        cells[r][c].formula=formula;
        String x =String.format("%.7g", Double.parseDouble(formula));
        cellsTF[r][c].setText(x);
